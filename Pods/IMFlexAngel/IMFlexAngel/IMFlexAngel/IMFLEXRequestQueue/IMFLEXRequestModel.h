...
/**
 *  网络数据请求Model，用于IMFLEXRequestQueue中
 *
...
@interface IMFLEXRequestModel : NSObject
...
@property (nonatomic, copy, readonly) void (^requestAction)(IMFLEXRequestModel *);

@property (nonatomic, copy, readonly) void (^requestCompleteAction)(IMFLEXRequestModel *);
