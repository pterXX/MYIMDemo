...
{
    [self setAssociatedObject:__tt_tipview_userData forKey:@"__tt_tipview_userData" association:IMAssociationStrong isAtomic:NO];
}
...
{
    [self setAssociatedObject:__tt_tipview_retryAction forKey:@"__tt_tipview_retryAction" association:IMAssociationStrong isAtomic:NO];
}
...
{
    [self setAssociatedObject:tt_tipView forKey:@"__tt_tipView" association:IMAssociationStrong isAtomic:NO];
}
- (UIView *)tt_tipView
{
