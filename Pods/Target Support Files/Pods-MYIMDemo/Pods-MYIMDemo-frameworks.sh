...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/IMFlexAngel/IMFlexAngel.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/IMShortcut/IMShortcut.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/KissXML/KissXML.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MJExtension/MJExtension.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/MJRefresh/MJRefresh.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Masonry/Masonry.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/PrivateKit/PrivateKit.framework"
