...
@implementation IMMyExpressionCell
...
- (void)setGroup:(IMExpressionGroupModel *)group
{
    _group = group;
...
- (void)p_initMyExpressionCellSubviews
{
    ...
    .title(@"移除").titleColor([UIColor grayColor]).titleFont([UIFont systemFontOfSize:13.0f])
