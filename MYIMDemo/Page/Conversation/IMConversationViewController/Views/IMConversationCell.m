...
{
    self.bottomSeperatorStyle = (indexPath.row == count - 1 ? IMConversationCellSeperatorStyleFill : IMConversationCellSeperatorStyleDefault);
}
...
- (void)setBottomSeperatorStyle:(IMConversationCellSeperatorStyle)bottomSeperatorStyle
{
...
- (void)setConversation:(IMConversation *)conversation
{
    ...
    if (conversation.avatarPath.length > 0) {
        ...
        [self.avatarView tt_setImageWithURL:IMURL(conversation.avatarURL) placeholderImage:[UIImage imageDefaultHeadPortrait]];
    }
    ...
    switch (conversation.remindType) {
        case IMMessageRemindTypeNormal:
            [self.remindImageView setHidden:YES];
            break;
        case IMMessageRemindTypeClosed:
            [self.remindImageView setImage:[UIImage imageNamed:@"conv_remind_close"]];
            break;
        case IMMessageRemindTypeNoIMook:
            [self.remindImageView setImage:[UIImage imageNamed:@"conv_remind_noIMock"]];
            break;
        case IMMessageRemindTypeUnlike:
