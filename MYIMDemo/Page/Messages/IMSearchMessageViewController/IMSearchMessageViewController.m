//
//  IMSearchMessageViewController.m
//  MYIMDemo
//
...
@interface IMSearchMessageViewController()<UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate>
...
@implementation IMSearchMessageViewController
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    if (self.searchList.count) {
        UIView *headView         = [[UIView alloc] initWithFrame:CGRectMake(0, 0, IMSCREEN_WIDTH, 40)];
        ...
        UIView *line = [[UIView alloc] initWithFrame:CGRectMake(15, headView.maxY-1, IMSCREEN_WIDTH-20, 1)];
