...
@implementation IMChatViewController (Image)
...
- (void)takePhoto
{
    IMSystemAuthorization *authorization = [IMSystemAuthorization shareInstance];
...
{
    IMVideoViewController *takePhoto = [[IMVideoViewController alloc] init];
    // 视频的最长时间限制
    ...
    takePhoto.takeBlock = ^(id item, NSString *filePath) {
        ...
        if ([item isKindOfClass:[NSURL class]]) {
            ...
            dispatch_async(dispatch_get_global_queue(0, 0), ^{
                ...
                __block IMMessageModel *messageModel    = [IMMessageModel new];
 ...
 */
- (void)saveAndSendMessageWithMessageModel:(IMMessageModel *)messageModel
