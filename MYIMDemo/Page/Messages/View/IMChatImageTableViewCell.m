...
@implementation IMChatImageTableViewCell
...
- (void) layoutSubviews
{
    ...
    if (self.messageModel.direction == IMMessageSenderTypeSender) {
    ...
    else if (self.messageModel.direction == IMMessageSenderTypeReceiver) {
        ...
        self.messageSendStatusImageView.frame = CGRectMake(self.messageImageView.maxX + MESSAGE_BACKGROUND_SPACE, self.messageImageView.maxY - 20, 20, 20);
    }
}
