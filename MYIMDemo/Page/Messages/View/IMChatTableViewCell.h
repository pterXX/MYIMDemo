...
#import "IMChatTableViewCellDelegate.h"

@class IMMessageModel;
@class KConversationModel;

@interface IMChatTableViewCell : UITableViewCell
// 发送或收到消息的时间
...
// cell代理事件
@property (nonatomic, assign) id<IMChatTableViewCellDelegate> delegate;
