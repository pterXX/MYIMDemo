//
//  IMMoreKeyboard+CollectionView.m
//  IMChat
//
...
#import "IMMoreKeyboard+CollectionView.h"
#import "IMMoreKeyboardCell.h"

#define     SPACE_TOP        15
#define     WIDTH_CELL       60

@implementation IMMoreKeyboard (CollectionView)

#pragma mark - Public Methods -
- (void)registerCellClass
{
    [self.collectionView registerClass:[IMMoreKeyboardCell class] forCellWithReuseIdentifier:@"IMMoreKeyboardCell"];
}
...
{
    IMMoreKeyboardCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"IMMoreKeyboardCell" forIndexPath:indexPath];
    ...
    [cell setClickBlock:^(IMMoreKeyboardItem *sItem) {
