...
@interface IMHorizontalPageFlowlayout : UICollectionViewFlowLayout
...
/**
 设置多少行及每行展示的item个数
 */
+ (instancetype)IMHorizontalPageFlowlayoutWithRowCount:(NSInteger)rowCount
                                      itemCountPerRow:(NSInteger)itemCountPerRow;
/**
 设置多少行及每行展示的item个数
 */
