...
@implementation IMHorizontalPageFlowlayout
...
#pragma mark - 构造方法
+ (instancetype)IMHorizontalPageFlowlayoutWithRowCount:(NSInteger)rowCount itemCountPerRow:(NSInteger)itemCountPerRow
{
...
{
    // 只支持水平方向上的滚动
    return CGSizeMake(self.pageNumber * IMSCREEN_WIDTH, 0);
}
