...
@implementation IMInputBoxMoreUnitView
...
- (void)initView
{
    ...
    self.titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, self.box.maxY + 5, INPUT_BOX_MORE_ITEM_WIDTH, 20)];
...
- (void)setMoreModel:(IMInputBoxMoreModel *)moreModel
{
