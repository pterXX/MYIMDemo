...
- (void)layoutSubviews
{
    ...
    if (self.messageModel.direction == IMMessageSenderTypeSender)
    {
        ...
        self.second.frame = CGRectMake(self.messageBackgroundImageView.mj_x - MESSAGE_BACKGROUND_SPACE - 30, self.messageBackgroundImageView.maxY - 20 - 5, 30, 20);
    ...
    else
    {
        ...
        self.messageBackgroundImageView.frame = CGRectMake(self.avatarImageView.maxX + MESSAGE_BACKGROUND_SPACE, self.username.mj_y + self.username.mj_h, width + 2 * MESSAGE_BACKGROUND_SPACE, AVATAR_WIDTH);
        self.voiceImageView.frame = CGRectMake(MESSAGE_BACKGROUND_SPACE, MESSAGE_BACKGROUND_SPACE, AVATAR_WIDTH - 25, AVATAR_WIDTH - 20);
        self.second.frame = CGRectMake(self.messageBackgroundImageView.maxX + MESSAGE_BACKGROUND_SPACE, self.messageBackgroundImageView.maxY - 20 - 5, 30, 20);
        self.second.textAlignment = NSTextAlignmentLeft;
        self.messageSendStatusImageView.frame = CGRectMake(self.second.maxX + MESSAGE_BACKGROUND_SPACE, self.second.maxY - 20, 20, 20);
    }
}
...
-(CGFloat)voiceLength:(NSInteger)millisecond
{
    ...
    CGFloat max = IMSCREEN_WIDTH > 375 ? 230 : 197;
