...
- (void)resetListWithContactsData:(NSArray *)contactsData sectionHeaders:(NSArray *)sectionHeaders
{
    ...
    {
        IMContactsItem *newModel = createContactsItemModelWithTag(IMContactsVCCellTypeNew, @"friends_new", nil, @"新的朋友", nil, nil);
        IMContactsItem *groupModel = createContactsItemModelWithTag(IMContactsVCCellTypeGroup, @"friends_group", nil, @"群聊", nil, nil);
        IMContactsItem *tagModel = createContactsItemModelWithTag(IMContactsVCCellTypeTag, @"friends_tag", nil, @"标签", nil, nil);
        IMContactsItem *publicModel = createContactsItemModelWithTag(IMContactsVCCellTypePublic, @"friends_public", nil, @"公众号", nil, nil);
