...
@implementation IMAppDefaultUtil

+ (instancetype)sharedInstance {
    
    static IMAppDefaultUtil *_sharedClient = nil;
...
+ (instancetype)allocWithZone:(struct _NSZone *)zone {
    return [IMAppDefaultUtil sharedInstance];
}
...
// 获取邮箱信息
- (IMMailAccountInfoModel *)getMailInfo {
    
    IMMailAccountInfoModel *mailModel = [IMMailAccountInfoModel new];
