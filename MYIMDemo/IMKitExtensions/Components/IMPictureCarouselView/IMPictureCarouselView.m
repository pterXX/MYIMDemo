...
@interface IMPictureCarouselView () <UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
...
@implementation IMPictureCarouselView
...
- (id)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        [self.collectionView registerClass:[IMPictureCarouselViewCell class] forCellWithReuseIdentifier:@"IMPictureCarouselViewCell"];
    }
    return self;
}
...
{
    id<IMPictureCarouselProtocol> model = self.data[indexPath.row];
    IMPictureCarouselViewCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"IMPictureCarouselViewCell" forIndexPath:indexPath];
    [cell setModel:model];
    return cell;
}
