...
#pragma mark - # IMFlexibleLayoutAttributes
@interface IMFlexibleLayoutAttributes : UICollectionViewLayoutAttributes
/// 背景色
@property (nonatomic, strong) UIColor *backgroudColor;

@end

@implementation IMFlexibleLayoutAttributes

@end


#pragma mark - # IMFlexibleLayoutReusableView
@interface IMFlexibleLayoutReusableView : UICollectionReusableView

@end

@implementation IMFlexibleLayoutReusableView

- (void)applyLayoutAttributes:(IMFlexibleLayoutAttributes *)layoutAttributes
{
...
#pragma mark - # IMFlexibleLayoutFlowLayout
@interface IMFlexibleLayoutFlowLayout  ()

@property (nonatomic, strong) NSMutableArray<UICollectionViewLayoutAttributes *> *decorationViewAttributes;

@end

@implementation IMFlexibleLayoutFlowLayout

- (void)prepareLayout
{
    [super prepareLayout];
    
    id<IMFlexibleLayoutFlowLayoutDelegate> delegate = (id<IMFlexibleLayoutFlowLayoutDelegate>)self.collectionView.delegate;
    ...
    [self registerClass:[IMFlexibleLayoutReusableView class] forDecorationViewOfKind:@"IMFlexibleLayoutReusableView"];
    for (NSInteger section = 0; section < [self.collectionView numberOfSections]; section++) {
        ...
        // 配置
        IMFlexibleLayoutAttributes *attribute = [IMFlexibleLayoutAttributes layoutAttributesForDecorationViewOfKind:@"IMFlexibleLayoutReusableView" withIndexPath:[NSIndexPath indexPathForRow:0 inSection:section]];
