//
//  IMImageMessageCell.m
//  IMChat
//
//  Created by 徐世杰 on 16/3/14.
...
@interface IMImageMessageCell ()

@property (nonatomic, strong) IMMessageImageView *msgImageView;

@end

@implementation IMImageMessageCell
...
- (void)setMessage:(IMImageMessage *)message
{
...
#pragma mark - Getter -
- (IMMessageImageView *)msgImageView
{
    if (_msgImageView == nil) {
        _msgImageView = [[IMMessageImageView alloc] init];
