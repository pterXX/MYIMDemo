...
#import "IMExpressionMoreCell.h"

@interface IMExpressionMoreCell ()
...
@implementation IMExpressionMoreCell
...
- (void)setGroupModel:(IMExpressionGroupModel *)groupModel
{
    ...
    if (image) {
        ...
        [self.imageView tt_setImageWithURL:IMURL(groupModel.iconURL) placeholderImage:[UIImage imageWithColor:[UIColor colorGrayBG]]];
    }
}
