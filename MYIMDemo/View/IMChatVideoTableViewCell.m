...
- (void)layoutSubviews {
    ...
    if (self.messageModel.direction == IMMessageSenderTypeSender) {
        ...
        self.messageSendStatusImageView.frame = CGRectMake(self.videoImageView.mj_x - MESSAGE_BACKGROUND_SPACE - 20, self.videoImageView.maxY - 20, 20, 20);
    }
    else {
        ...
        [self.videoImageView setOrigin:CGPointMake(x, y)];
        [self.messageBackgroundImageView setFrame:CGRectMake(0, 0, 0, 0)];
        self.messageSendStatusImageView.frame = CGRectMake(self.videoImageView.maxX + MESSAGE_BACKGROUND_SPACE, self.videoImageView.maxY - 20, 20, 20);
    }
